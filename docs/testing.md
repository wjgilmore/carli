...
| Terminal-mode preservation | Normal exit, signal termination, shell recovery after stop, and stopped-job mode restoration through `fg` in isolated `tests/pty_edge_cases.py` scenarios |
